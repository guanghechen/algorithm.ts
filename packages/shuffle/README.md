<header>
  <h1 align="center">
    <a href="https://github.com/guanghechen/algorithm.ts/tree/@algorithm.ts/shuffle@4.0.0-alpha.0/packages/shuffle#readme">@algorithm.ts/shuffle</a>
  </h1>
  <div align="center">
...
[homepage]:
  https://github.com/guanghechen/algorithm.ts/tree/@algorithm.ts/shuffle@4.0.0-alpha.0/packages/shuffle#readme
